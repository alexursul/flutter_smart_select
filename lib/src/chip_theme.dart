  ...
  Widget build(BuildContext context) {
    ...
    final Color primaryColor = color ??
        (!isDark
            ...
            : ChipTheme.of(context).backgroundColor) ?? Theme.of(context).unselectedWidgetColor;
    ...
    final TextStyle defaultLabelStyle = ChipTheme.of(context).labelStyle ?? Theme.of(context).textTheme.bodyText1!;
